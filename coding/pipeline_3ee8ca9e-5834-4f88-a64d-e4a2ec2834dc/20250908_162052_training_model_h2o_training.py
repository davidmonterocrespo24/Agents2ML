# TRAINING SCRIPT
# Generated on: 2025-09-08T16:20:52.453340
# Pipeline: pipeline_3ee8ca9e-5834-4f88-a64d-e4a2ec2834dc
# Filename: model_h2o_training.py
# Arguments: --file 3ee8ca9e-5834-4f88-a64d-e4a2ec2834dc.csv --output-dir ./ --max_rows_for_validation 50000
...
def extract_metrics(leader_model, frame):
    metrics = {}
    try:
        predictions = leader_model.predict(frame)
...
def main(args):
    ...
    try:
        ...
        # For unsupervised learning, use the entire dataset for training
        train = hf
        ...
        # FIX_APPLIED: Remove validation frame for unsupervised learning
        ...
        metrics = {}
        try:
            metrics = extract_metrics(leader, train)
        except Exception as e:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target', required=False, default=None, help='Target column (not used for unsupervised)')
    ...
    parser.add_argument('--max_rows_for_validation', type=int, default=50000, help='Max rows for training')

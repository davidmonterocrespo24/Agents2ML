# TRAINING SCRIPT
# Generated on: 2025-09-04T12:48:48.921508
# Pipeline: pipeline_c4817250-b02b-49ac-a00b-e7f87e432343
# Filename: model_h2o_training.py
# Arguments: --file c4817250-b02b-49ac-a00b-e7f87e432343_ventas.csv --target monto_total --sep ";" --max_runtime_secs 180 --max_models 5 --nthreads 2 --max_mem_size 1G
...
def main():
    ...
    try:
        ...
        parser.add_argument('--target', default='monto_total', help='Name of the target column')
        ...
        parser.add_argument('--max_mem_size', default='2G', help='Max memory for h2o.init')
        parser.add_argument('--nthreads', type=int, default=2, help='H2O threads')
        parser.add_argument('--stopping_metric', default='RMSE', help='Stopping metric for AutoML')
        ...
        # FIX_APPLIED: Only convert boolean columns to factors, not numeric time features
        # Mark appropriate columns as factors (only boolean/indicator columns)
